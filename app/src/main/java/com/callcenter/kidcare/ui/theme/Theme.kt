package com.callcenter.kidcare.ui.theme
...
private val LightColorPalette = KidCareColors(
    brand = Shadow5,
...
private val DarkColorPalette = KidCareColors(
    brand = Shadow1,
...
object KidCareTheme {
    val colors: KidCareColors
        @Composable
        get() = LocalKidCareColors.current
}

/**
 * KidCare custom Color Palette
 */
@Immutable
data class KidCareColors(
...
@Composable
fun ProvideKidCareColors(
    colors: KidCareColors,
    content: @Composable () -> Unit
) {
    CompositionLocalProvider(LocalKidCareColors provides colors, content = content)
}

private val LocalKidCareColors = staticCompositionLocalOf<KidCareColors> {
    error("No KidCare ColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colorScheme] in preference to [KidCareTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
